...
The Ollama Codespace pre-installs Ollama and pulls the `qwen3.5:0.6b` model, and copies `.env.sample.ollama` as your `.env` file. Note that the 64GB memory requirement will consume your Codespace quota faster.
